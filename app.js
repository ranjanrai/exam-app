...
<div id="lockScreen"
  ...
  <div id="examInner">
    <div id="fsUser">
     ...
     <!-- Student Live Camera Preview -->
  <video id="examCameraPreview" autoplay playsinline muted
         style="width:120px;height:120px;border-radius:12px;object-fit:cover;margin-top:12px;display:none;"></video>

  <!-- Remote stream (admin monitoring) -->
  <video id="remoteVideo" autoplay playsinline muted
         style="width:20%;max-height:50px;border-radius:12px;margin-top:12px"></video>
